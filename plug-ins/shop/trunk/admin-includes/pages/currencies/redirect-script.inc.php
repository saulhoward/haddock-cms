 ...
 * rows in the currencies table in the shop plug-in.
 *
...
if (isset($_GET['delete_id'])) {
    $currencies_table->delete_by_id($_GET['delete_id']);
...
if (isset($_GET['add_row'])) {
        ...
        $last_added_id = $currencies_table->add_currency(
            $_POST['name'],
            $_POST['iso_4217_code'],
            $_POST['symbol']
        );
...
if (isset($_GET['edit_id'])) {
    $currencies_table->edit_currency(
        $_GET['edit_id'],
        $_POST['name'],
            $_POST['iso_4217_code'],
            $_POST['symbol']
