<?php
/**
 * Check that the product_category's id has been set.
 *
...
if (isset($_GET['product_category_id'])) {
    ...
    $gvm->set('product_category', $product_category);
} else {
    throw new Exception('No product category ID set on product category page!');
}
?>
