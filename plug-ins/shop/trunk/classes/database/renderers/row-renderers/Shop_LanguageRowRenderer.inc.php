<?php
/**
 * Shop_LanguageRowRenderer.inc.php
 *
...
class
    Shop_LanguageRowRenderer
extends
    Database_RowRenderer
{
    public function
        get_admin_languages_html_table_tr($current_page_url)
    {
	...
	$name_field = $table->get_field('name');
        ...
        $html_row->append_tag_to_content($name_td);
         ...
         $iso_639_1_code_field = $table->get_field('iso_639_1_code');
        $iso_639_1_code_td = $this->get_data_html_table_td($iso_639_1_code_field);
        $html_row->append_tag_to_content($iso_639_1_code_td);
