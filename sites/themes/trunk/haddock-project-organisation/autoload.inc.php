...
function __autoload($class_name)
{
	switch ($class_name) {
		...
		case('HaddockCMSThemes_HomeHTMLPage'): 
			require_once PROJECT_ROOT . DIRECTORY_SEPARATOR . 'project-specific' . DIRECTORY_SEPARATOR . 'classes' . DIRECTORY_SEPARATOR . 'pages' . DIRECTORY_SEPARATOR . 'html' . DIRECTORY_SEPARATOR . 'HaddockCMSThemes_HomeHTMLPage.inc.php';
			break;
