...
function __autoload($class_name)
{
	switch ($class_name) {
		...
		case('Admin_AddUserCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/cli-scripts/Admin_AddUserCLIScript.inc.php';
			break;

		case('Admin_AdminIncluderURLFactory'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_AdminIncluderURLFactory.inc.php';
			break;

		case('Admin_ConfigManager'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_ConfigManager.inc.php';
			break;

		case('Admin_DeleteAllUsersCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/cli-scripts/Admin_DeleteAllUsersCLIScript.inc.php';
			break;

		case('Admin_DeleteUserCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/cli-scripts/Admin_DeleteUserCLIScript.inc.php';
			break;

		case('Admin_EditUserCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/cli-scripts/Admin_EditUserCLIScript.inc.php';
			break;

		case('Admin_HTMLPage'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/pages/Admin_HTMLPage.inc.php';
			break;

		case('Admin_IncFileFinder'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_IncFileFinder.inc.php';
			break;

		case('Admin_IncludesDirectory'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_IncludesDirectory.inc.php';
			break;

		case('Admin_ListUsersCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/cli-scripts/Admin_ListUsersCLIScript.inc.php';
			break;

		case('Admin_LogInHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/helpers/Admin_LogInHelper.inc.php';
			break;

		case('Admin_LoginManager'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_LoginManager.inc.php';
			break;

		case('Admin_ModuleLinksUL'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/html-tags/Admin_ModuleLinksUL.inc.php';
			break;

		case('Admin_ModuleTitleFile'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_ModuleTitleFile.inc.php';
			break;

		case('Admin_NavigationLinksFile'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_NavigationLinksFile.inc.php';
			break;

		case('Admin_NavigationXMLFile'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_NavigationXMLFile.inc.php';
			break;

		case('Admin_NXFPage'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_NXFPage.inc.php';
			break;

		case('Admin_PageDirectory'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_PageDirectory.inc.php';
			break;

		case('Admin_PagesDirectory'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_PagesDirectory.inc.php';
			break;

		case('Admin_ResetAllUsersPasswordsCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/cli-scripts/Admin_ResetAllUsersPasswordsCLIScript.inc.php';
			break;

		case('Admin_ResetUserPasswordCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/cli-scripts/Admin_ResetUserPasswordCLIScript.inc.php';
			break;

		case('Admin_RestrictedHTMLPage'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/pages/Admin_RestrictedHTMLPage.inc.php';
			break;

		case('Admin_RestrictedRedirectScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/pages/Admin_RestrictedRedirectScript.inc.php';
			break;

		case('Admin_ShowUserCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/cli-scripts/Admin_ShowUserCLIScript.inc.php';
			break;

		case('Admin_SiteMapUL'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/html-tags/Admin_SiteMapUL.inc.php';
			break;

		case('Admin_StartPage'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/pages/Admin_StartPage.inc.php';
			break;

		case('Admin_StartPageWidget'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/Admin_StartPageWidget.inc.php';
			break;

		case('Admin_UserEntry'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/persistence/entries/Admin_UserEntry.inc.php';
			break;

		case('Admin_UserRow'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/database/elements/row-subclasses/Admin_UserRow.inc.php';
			break;

		case('Admin_UserRowRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/database/renderers/row-renderers/Admin_UserRowRenderer.inc.php';
			break;

		case('Admin_UsersHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/helpers/Admin_UsersHelper.inc.php';
			break;

		case('Admin_UsersTable'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/database/elements/table-subclasses/Admin_UsersTable.inc.php';
			break;

		case('Admin_UsersTableRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/admin/classes/database/renderers/table-renderers/Admin_UsersTableRenderer.inc.php';
			break;

		case('Caching_CacheDirectoryCreator'): 
			require_once PROJECT_ROOT . '/plug-ins/caching/classes/Caching_CacheDirectoryCreator.inc.php';
			break;

		case('Caching_CacheManager'): 
			require_once PROJECT_ROOT . '/plug-ins/caching/classes/Caching_CacheManager.inc.php';
			break;

		case('Caching_GlobalVarManager'): 
			require_once PROJECT_ROOT . '/plug-ins/caching/classes/Caching_GlobalVarManager.inc.php';
			break;

		case('Caching_SessionVarManager'): 
			require_once PROJECT_ROOT . '/plug-ins/caching/classes/Caching_SessionVarManager.inc.php';
			break;
		...
		case('Database_AddConditionsToWhereClauseBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/behaviours/Database_AddConditionsToWhereClauseBehaviour.inc.php';
			break;

		case('Database_AddKeyValuePairsToSetClauseBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/behaviours/Database_AddKeyValuePairsToSetClauseBehaviour.inc.php';
			break;

		case('Database_AddRowOLForm'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/html-tags/Database_AddRowOLForm.inc.php';
			break;

		case('Database_AdminXMLPageManager'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_AdminXMLPageManager.inc.php';
			break;

		case('Database_ApplyUnappliedDeltaFilesCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_ApplyUnappliedDeltaFilesCLIScript.inc.php';
			break;

		case('Database_BlobField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_BlobField.inc.php';
			break;

		case('Database_BlobFieldRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/field-renderers/Database_BlobFieldRenderer.inc.php';
			break;

		case('Database_Cell'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/Database_Cell.inc.php';
			break;

		case('Database_ChoiceField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_ChoiceField.inc.php';
			break;

		case('Database_ChoiceFieldRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/field-renderers/Database_ChoiceFieldRenderer.inc.php';
			break;

		case('Database_ConfigManager'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/managers/config/Database_ConfigManager.inc.php';
			break;

		case('Database_ConnectionsHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_ConnectionsHelper.inc.php';
			break;

		case('Database_CreateDeltaFileCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_CreateDeltaFileCLIScript.inc.php';
			break;

		case('Database_CreateImageCacheDirectoryCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_CreateImageCacheDirectoryCLIScript.inc.php';
			break;

		case('Database_CreateMySQLUserAndDatabaseCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_CreateMySQLUserAndDatabaseCLIScript.inc.php';
			break;

		case('Database_CreatePasswordsFileCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_CreatePasswordsFileCLIScript.inc.php';
			break;

		case('Database_CRUDAdminManager'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_CRUDAdminManager.inc.php';
			break;

		case('Database_CRUDAdminPage'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/pages/Database_CRUDAdminPage.inc.php';
			break;

		case('Database_CRUDAdminRedirectScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/pages/Database_CRUDAdminRedirectScript.inc.php';
			break;

		case('Database_CRUDException'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/exceptions/Database_CRUDException.inc.php';
			break;

		case('Database_Database'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/Database_Database.inc.php';
			break;

		case('Database_DatabaseClassFactory'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_DatabaseClassFactory.inc.php';
			break;

		case('Database_DatabaseClassFactoryTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_DatabaseClassFactoryTests.inc.php';
			break;

		case('Database_DatabaseClassFinder'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_DatabaseClassFinder.inc.php';
			break;

		case('Database_DatabaseClassNameFile'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_DatabaseClassNameFile.inc.php';
			break;

		case('Database_DatabaseClassNameFileTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_DatabaseClassNameFileTests.inc.php';
			break;

		case('Database_DatabaseClassNameOverride'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_DatabaseClassNameOverride.inc.php';
			break;

		case('Database_DatabaseClassNameOverrideFile'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_DatabaseClassNameOverrideFile.inc.php';
			break;

		case('Database_DatabaseDescribingTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_DatabaseDescribingTests.inc.php';
			break;

		case('Database_DatabaseHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_DatabaseHelper.inc.php';
			break;

		case('Database_DatabaseNameValidator'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/input-validation/Database_DatabaseNameValidator.inc.php';
			break;

		case('Database_DatabaseRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/Database_DatabaseRenderer.inc.php';
			break;

		case('Database_DateTimeField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_DateTimeField.inc.php';
			break;

		case('Database_DBHandleTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_DBHandleTests.inc.php';
			break;

		case('Database_DBSubClassesDirectory'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_DBSubClassesDirectory.inc.php';
			break;

		case('Database_DelegateRow'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/row-subclasses/Database_DelegateRow.inc.php';
			break;

		case('Database_DeletableRow'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/interfaces/row-interfaces/Database_DeletableRow.inc.php';
			break;

		case('Database_DeletableRowDeleteBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/behaviours/row-behaviours/Database_DeletableRowDeleteBehaviour.inc.php';
			break;

		case('Database_DeltaFile'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/file-system/files/Database_DeltaFile.inc.php';
			break;

		case('Database_DeltaFilesHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_DeltaFilesHelper.inc.php';
			break;

		case('Database_DeltasDirectory'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/file-system/directories/Database_DeltasDirectory.inc.php';
			break;

		case('Database_DeltasTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_DeltasTests.inc.php';
			break;

		case('Database_EditRowOLForm'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/html-tags/Database_EditRowOLForm.inc.php';
			break;

		case('Database_Element'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_Element.inc.php';
			break;

		case('Database_ElementTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_ElementTests.inc.php';
			break;

		case('Database_EmailAddressVarCharField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_EmailAddressVarCharField.inc.php';
			break;

		case('Database_EntityNameValidator'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/input-validation/Database_EntityNameValidator.inc.php';
			break;

		case('Database_Entry'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/persistence/entries/Database_Entry.inc.php';
			break;

		case('Database_EnumField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_EnumField.inc.php';
			break;

		case('Database_FetchingHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_FetchingHelper.inc.php';
			break;

		case('Database_Field'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/Database_Field.inc.php';
			break;

		case('Database_FieldNotInTableException'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/exceptions/Database_FieldNotInTableException.inc.php';
			break;

		case('Database_FieldRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/Database_FieldRenderer.inc.php';
			break;

		case('Database_FilesTableRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/table-renderers/Database_FilesTableRenderer.inc.php';
			break;

		case('Database_ForeignKeyRow'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/row-subclasses/Database_ForeignKeyRow.inc.php';
			break;

		case('Database_ForeignKeyTable'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/table-subclasses/Database_ForeignKeyTable.inc.php';
			break;

		case('Database_GetSetClauseBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/behaviours/Database_GetSetClauseBehaviour.inc.php';
			break;

		case('Database_GetWhereClauseBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/behaviours/Database_GetWhereClauseBehaviour.inc.php';
			break;

		case('Database_HostNameValidator'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/input-validation/Database_HostNameValidator.inc.php';
			break;

		case('Database_HostNameValidatorTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_HostNameValidatorTests.inc.php';
			break;

		case('Database_HTMLPreFieldRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/field-renderers/Database_HTMLPreFieldRenderer.inc.php';
			break;

		case('Database_ImageCacheHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_ImageCacheHelper.inc.php';
			break;

		case('Database_ImageFieldRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/field-renderers/Database_ImageFieldRenderer.inc.php';
			break;

		case('Database_ImageRow'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/row-subclasses/Database_ImageRow.inc.php';
			break;

		case('Database_ImageRowRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/row-renderers/Database_ImageRowRenderer.inc.php';
			break;

		case('Database_ImagesHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_ImagesHelper.inc.php';
			break;

		case('Database_ImagesTable'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/table-subclasses/Database_ImagesTable.inc.php';
			break;

		case('Database_ImagesTableRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/table-renderers/Database_ImagesTableRenderer.inc.php';
			break;

		case('Database_InputSanitationHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_InputSanitationHelper.inc.php';
			break;

		case('Database_IntField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_IntField.inc.php';
			break;

		case('Database_InvalidUserInputException'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/exceptions/Database_InvalidUserInputException.inc.php';
			break;

		case('Database_LimitForm'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/html-tags/Database_LimitForm.inc.php';
			break;

		case('Database_ListDeltaFileApplicationsCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_ListDeltaFileApplicationsCLIScript.inc.php';
			break;

		case('Database_ListDeltaFilesCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_ListDeltaFilesCLIScript.inc.php';
			break;

		case('Database_ListUnappliedDeltaFilesCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_ListUnappliedDeltaFilesCLIScript.inc.php';
			break;

		case('Database_LongTextFieldRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/field-renderers/Database_LongTextFieldRenderer.inc.php';
			break;

		case('Database_ManageSimpleCRUDAdminPage'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/pages/crud-pages/simple-crud/Database_ManageSimpleCRUDAdminPage.inc.php';
			break;

		case('Database_ManageSimpleCRUDAdminRedirectScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/pages/crud-pages/simple-crud/Database_ManageSimpleCRUDAdminRedirectScript.inc.php';
			break;

		case('Database_ModifyingStatementHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_ModifyingStatementHelper.inc.php';
			break;

		case('Database_MySQLException'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/exceptions/Database_MySQLException.inc.php';
			break;

		case('Database_MySQLRootUser'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_MySQLRootUser.inc.php';
			break;

		case('Database_MySQLUser'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_MySQLUser.inc.php';
			break;

		case('Database_MySQLUserFactory'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_MySQLUserFactory.inc.php';
			break;

		case('Database_NumericField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_NumericField.inc.php';
			break;

		case('Database_PageRow'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/database/elements/row-subclasses/Database_PageRow.inc.php';
			break;

		case('Database_PageRowRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/database/renderers/row-renderers/Database_PageRowRenderer.inc.php';
			break;

		case('Database_PagesTable'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/database/elements/table-subclasses/Database_PagesTable.inc.php';
			break;

		case('Database_PagesTableRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/database/renderers/table-renderers/Database_PagesTableRenderer.inc.php';
			break;

		case('Database_PasswordFile'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_PasswordFile.inc.php';
			break;

		case('Database_PasswordsDirectoryTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_PasswordsDirectoryTests.inc.php';
			break;

		case('Database_PasswordsFileHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_PasswordsFileHelper.inc.php';
			break;

		case('Database_PasswordsFileTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_PasswordsFileTests.inc.php';
			break;

		case('Database_PasswordValidator'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/input-validation/Database_PasswordValidator.inc.php';
			break;

		case('Database_PreviousNextUL'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/html-tags/Database_PreviousNextUL.inc.php';
			break;

		case('Database_Renderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_Renderer.inc.php';
			break;

		case('Database_ResetDatabaseCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_ResetDatabaseCLIScript.inc.php';
			break;

		case('Database_Row'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/Database_Row.inc.php';
			break;

		case('Database_RowBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/behaviours/Database_RowBehaviour.inc.php';
			break;

		case('Database_RowNotFoundException'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/exceptions/Database_RowNotFoundException.inc.php';
			break;

		case('Database_RowOLForm'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/html-tags/Database_RowOLForm.inc.php';
			break;

		case('Database_RowRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/Database_RowRenderer.inc.php';
			break;

		case('Database_SelectionHTMLDiv'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/html-tags/Database_SelectionHTMLDiv.inc.php';
			break;

		case('Database_SelectionManager'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/selection-managers/Database_SelectionManager.inc.php';
			break;

		case('Database_SelectionManagerFactory'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/selection-managers/Database_SelectionManagerFactory.inc.php';
			break;

		case('Database_SelectionManagersFile'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/selection-managers/Database_SelectionManagersFile.inc.php';
			break;

		case('Database_ShortTextFieldRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/field-renderers/Database_ShortTextFieldRenderer.inc.php';
			break;

		case('Database_SimpleCRUDManager'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/pages/crud-pages/simple-crud/Database_SimpleCRUDManager.inc.php';
			break;

		case('Database_SortableHeadingTR'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/html-tags/Database_SortableHeadingTR.inc.php';
			break;

		case('Database_SortableRow'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/interfaces/row-interfaces/Database_SortableRow.inc.php';
			break;

		case('Database_SortableRowBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/behaviours/row-behaviours/Database_SortableRowBehaviour.inc.php';
			break;

		case('Database_SortableRowMaxSortOrderBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/behaviours/row-behaviours/Database_SortableRowMaxSortOrderBehaviour.inc.php';
			break;

		case('Database_SortableRowMinSortOrderBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/behaviours/row-behaviours/Database_SortableRowMinSortOrderBehaviour.inc.php';
			break;

		case('Database_SortableRowMoveDownBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/behaviours/row-behaviours/Database_SortableRowMoveDownBehaviour.inc.php';
			break;

		case('Database_SortableRowMoveUpBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/delegation/behaviours/row-behaviours/Database_SortableRowMoveUpBehaviour.inc.php';
			break;

		case('Database_SpecifiedTable'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_SpecifiedTable.inc.php';
			break;

		case('Database_SpecifiedTableFieldTypeTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_SpecifiedTableFieldTypeTests.inc.php';
			break;

		case('Database_SQLClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLClause.inc.php';
			break;

		case('Database_SQLDeleteStatement'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/statements/Database_SQLDeleteStatement.inc.php';
			break;

		case('Database_SQLDirectory'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_SQLDirectory.inc.php';
			break;

		case('Database_SQLFile'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/file-system/files/Database_SQLFile.inc.php';
			break;

		case('Database_SQLFromClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLFromClause.inc.php';
			break;

		case('Database_SQLFromClauseJoinSubSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLFromClauseJoinSubSubClause.inc.php';
			break;

		case('Database_SQLFromClauseTableReference'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLFromClauseTableReference.inc.php';
			break;

		case('Database_SQLInsertStatement'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/statements/Database_SQLInsertStatement.inc.php';
			break;

		case('Database_SQLLimitClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLLimitClause.inc.php';
			break;

		case('Database_SQLOrderByClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLOrderByClause.inc.php';
			break;

		case('Database_SQLOrderByClauseFieldSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLOrderByClauseFieldSubClause.inc.php';
			break;

		case('Database_SQLSelectClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLSelectClause.inc.php';
			break;

		case('Database_SQLSelectClauseFieldSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLSelectClauseFieldSubClause.inc.php';
			break;

		case('Database_SQLSelectQuery'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/statements/Database_SQLSelectQuery.inc.php';
			break;

		case('Database_SQLSetClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLSetClause.inc.php';
			break;

		case('Database_SQLStatement'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/statements/Database_SQLStatement.inc.php';
			break;

		case('Database_SQLStatementBehaviour'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/behaviours/Database_SQLStatementBehaviour.inc.php';
			break;

		case('Database_SQLStatementWithSetClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/statements/Database_SQLStatementWithSetClause.inc.php';
			break;

		case('Database_SQLStatementWithWhereClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/statements/Database_SQLStatementWithWhereClause.inc.php';
			break;

		case('Database_SQLSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLSubClause.inc.php';
			break;

		case('Database_SQLUpdateClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLUpdateClause.inc.php';
			break;

		case('Database_SQLUpdateClauseFieldSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLUpdateClauseFieldSubClause.inc.php';
			break;

		case('Database_SQLUpdateClauseQuotedValueFieldSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLUpdateClauseQuotedValueFieldSubClause.inc.php';
			break;

		case('Database_SQLUpdateStatement'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/statements/Database_SQLUpdateStatement.inc.php';
			break;

		case('Database_SQLWhereClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLWhereClause.inc.php';
			break;

		case('Database_SQLWhereClauseBinaryOperatorConditionSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLWhereClauseBinaryOperatorConditionSubClause.inc.php';
			break;

		case('Database_SQLWhereClauseConditionSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLWhereClauseConditionSubClause.inc.php';
			break;

		case('Database_SQLWhereClauseFieldInListConditionSubClause'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/sql/clauses/Database_SQLWhereClauseFieldInListConditionSubClause.inc.php';
			break;

		case('Database_StringField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_StringField.inc.php';
			break;

		case('Database_SyncDatabaseWithTableSpecificationCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_SyncDatabaseWithTableSpecificationCLIScript.inc.php';
			break;

		case('Database_SyncTableSpecificationWithDatabaseCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/cli-scripts/Database_SyncTableSpecificationWithDatabaseCLIScript.inc.php';
			break;

		case('Database_Table'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/Database_Table.inc.php';
			break;

		case('Database_TableHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_TableHelper.inc.php';
			break;

		case('Database_TableNameTranslator'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_TableNameTranslator.inc.php';
			break;

		case('Database_TableNameTranslatorFactory'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/Database_TableNameTranslatorFactory.inc.php';
			break;

		case('Database_TableRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/Database_TableRenderer.inc.php';
			break;

		case('Database_TableSpecificationDirectory'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/table-structure-synchronisation/Database_TableSpecificationDirectory.inc.php';
			break;

		case('Database_TableSpecificationFile'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/table-structure-synchronisation/Database_TableSpecificationFile.inc.php';
			break;

		case('Database_TableSpecificationHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/helpers/Database_TableSpecificationHelper.inc.php';
			break;

		case('Database_TableSpecificationTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_TableSpecificationTests.inc.php';
			break;

		case('Database_TableStructureManager'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/table-structure-synchronisation/Database_TableStructureManager.inc.php';
			break;

		case('Database_TemporalField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_TemporalField.inc.php';
			break;

		case('Database_TextField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_TextField.inc.php';
			break;

		case('Database_TimeFieldRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/renderers/field-renderers/Database_TimeFieldRenderer.inc.php';
			break;

		case('Database_UnableToMakeConnectionException'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/exceptions/Database_UnableToMakeConnectionException.inc.php';
			break;

		case('Database_UserInputTooLongException'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/exceptions/Database_UserInputTooLongException.inc.php';
			break;

		case('Database_UsernameValidator'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/input-validation/Database_UsernameValidator.inc.php';
			break;

		case('Database_UsernameValidatorTests'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/unit-tests/Database_UsernameValidatorTests.inc.php';
			break;

		case('Database_VarCharField'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/elements/field-subclasses/Database_VarCharField.inc.php';
			break;
		...
		case('DB'): 
			require_once PROJECT_ROOT . '/plug-ins/database/classes/DB.inc.php';
			break;
		...
		case('Logging_Logger'): 
			require_once PROJECT_ROOT . '/plug-ins/logging/classes/Logging_Logger.inc.php';
			break;

		case('Logging_LogsHelper'): 
			require_once PROJECT_ROOT . '/plug-ins/logging/classes/helpers/Logging_LogsHelper.inc.php';
			break;

		case('Logging_ResetLogsCLIScript'): 
			require_once PROJECT_ROOT . '/plug-ins/logging/classes/cli-scripts/Logging_ResetLogsCLIScript.inc.php';
			break;

		case('Logging_ServerLogsTable'): 
			require_once PROJECT_ROOT . '/plug-ins/logging/classes/database/elements/table-subclasses/Logging_ServerLogsTable.inc.php';
			break;

		case('Logging_ServerLogsTableRenderer'): 
			require_once PROJECT_ROOT . '/plug-ins/logging/classes/database/renderers/table-renderers/Logging_ServerLogsTableRenderer.inc.php';
			break;
